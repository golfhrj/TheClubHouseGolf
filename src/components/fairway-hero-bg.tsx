...
const SLIDES = [
  asset("/images/hero-course-sunset.jpg"),
  asset("/images/hero-coastal-polo.png"),
  asset("/images/hero-aerial-sunset.jpg"),
  asset("/images/hero-golden-fairway.jpg"),
  asset("/images/hero-treelined-fairway.jpg"),
];
